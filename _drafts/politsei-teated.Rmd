...
```{r liikluse_teated, fig.width = 8, fig.height = 6, fig.align = "center", message = FALSE, warning = FALSE}
...
```{r joobes_inimene_teated, fig.width = 8, fig.height = 6, fig.align = "center", message = FALSE, warning = FALSE}
